...
export default function Upload() {
  ...
  // Submits file to backend (/upload route)
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Attempt to parse server response as JSON
      let data = null;
      try {
      ...
      // Show row summary returned from backend
      setStatus(
        ...
        <div className="w-full flex justify-center items-start py-10">
          <div className="w-full max-w-xl bg-gray-900 border border-gray-700 rounded-xl shadow-lg p-6 text-gray-100">
            ...
            <p className="text-sm text-gray-300 mb-6">
              Select a <span className="font-semibold">.csv</span> file
              containing offensive play data to upload.
            </p>
